/*!
  * AXAdesignSystemLib  tab.js v1.0.0 (https://designsystem.axa.com)
...
(function (global, factory) {
  ...
  EventHandler__default.default.on(document, EVENT_MOUSEOVER_DATA_API, SELECTOR_DATA_TOGGLE_HOVER, function (event) {
    if (['A', 'AREA'].includes(this.tagName)) {
      event.preventDefault();
    }
  ...
  EventHandler__default.default.on(document, EVENT_MOUSELEAVE_DATA_API, SELECTOR_DATA_TOGGLE_DROPDOWN, function (event) {
    if (['A', 'AREA'].includes(this.tagName)) {
      event.preventDefault();
    }
