(() => {
  ...
  // ns-hugo:D:\Dev\Repos\axa-bootstrap\lib\site\assets\js\axaDesignSystemLib.js
  var require_axaDesignSystemLib = __commonJS({
    "ns-hugo:D:\\Dev\\Repos\\axa-bootstrap\\lib\\site\\assets\\js\\axaDesignSystemLib.js"(exports, module) {
      (function(global, factory) {
        ...
        const CLASS_NAME_SEARCH_ICON = "icon-search";
        const CLASS_NAME_TOGGLE_CLOSE = "toggle-close";
        const ID_MENU_OPEN = "nav-burger";
        const ID_MENU_CLOSE = "nav-close";
        const ID_SEARCHBAR = "inputSearch";
        const WIDTH = "width";
        const HEIGHT = "height";
        ...
        EventHandler.on(document, EVENT_MOUSELEAVE_DATA_API, SELECTOR_DATA_TOGGLE_DROPDOWN, function(event) {
          ...
          Array.from(data._element.children).forEach((child) => {
            if (child.classList.contains(CLASS_NAME_ACTIVE)) {
              Array.from(child.children[0].children).forEach((child2) => {
                if (child2.children[0].classList.contains(CLASS_NAME_ACTIVE)) {
                  Array.from(child2.children).forEach((child3) => {
                    document.getElementById(child3.getAttribute("data-bs-target").slice(1)).classList.remove(CLASS_NAME_ACTIVE);
                    child3.classList.remove(CLASS_NAME_ACTIVE);
                  });
                }
              });
            }
  ...
  // <stdin>
  var axalib = __toESM(require_axaDesignSystemLib());
  ...
  var searchInputRes = document.getElementById("search-input-res");
  var formSearchRes = document.getElementById("formSearchRes");
  var formSearch = document.getElementById("formSearch");
  searchInput.addEventListener("input", searchWord);
  searchInputRes.addEventListener("input", searchWord);
  var skipLinkItem = document.querySelectorAll(".skiplinkTitle");
  var skipLinkNav = document.getElementById("skiplink-nav");
...
/*!
  ...
  * Copyright 2021-2022 The AXA Design System Team
  * Licensed under MIT
